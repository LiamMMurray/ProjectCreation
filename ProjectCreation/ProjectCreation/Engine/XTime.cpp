...
void XTime::Restart()
{
        ...
        // reset counters
        localStack.deltaTime = localStack.totalTime = localStack.smoothDelta = localStack.lastSecond = 0.0;
...
void XTime::Signal()
{
        ...
        memmove_s(localStack.signals + 1u,
                  sizeof(LARGE_INTEGER) * 255,
                  localStack.signals,
        ...
        localStack.deltaTime =
            double(localStack.signals[0].QuadPart - localStack.signals[1].QuadPart) / double(localStack.frequency.QuadPart);
