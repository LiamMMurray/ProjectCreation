...
void PlayerGroundState::Update(float deltaTime)
{
        ...
        {
                eulerAngles.x += -JGamePad::Get()->leftStickY * angularSpeed;
                pitchDelta = eulerAngles.x - pitchDelta;

                eulerAngles.y += JGamePad::Get()->leftStickX * angularSpeed;
                yawDelta = eulerAngles.y - yawDelta;

                eulerAngles.z += JGamePad::Get()->leftStickX * angularSpeed;
